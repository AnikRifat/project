...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">subcategory</h4>
    </div>
    <div class="col-md-7 align-self-center text-end">
        <div class="d-flex justify-content-end align-items-center">
            ...
            <a href="{{ route('subcategory.index') }}" class="btn btn-info d-none d-lg-block m-l-15 text-white"><i
                  class="fa fa-bar"></i>All subcategory</a>
        </div>
    </div>
</div>
<!-- ============================================================== -->
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h3 class="m-b-0 text-dark">Add subcategory</h3>
                @if ($errors->any())
                <div style="color: red;">
                    <ul>
            ...
            <div class="card-body">
                <form action="{{ route('subcategory.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="Enter subsubcategory name">
                        @error('name')
